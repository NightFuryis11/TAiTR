...
{
	public class Bubble1 : ModProjectile
	{
		...
		public override void Kill(int timeLeft) {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Projectile.NewProjectile(projectile.Center, vel, ProjectileType<Bubble2>(), projectile.damage, projectile.knockBack, projectile.owner, 0, 1);
            }
        }
